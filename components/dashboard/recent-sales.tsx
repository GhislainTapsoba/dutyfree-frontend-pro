                  ...
                  <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge variant="outline" className="text-xs h-5">
                            ...
                            {sale.payment_method === "cash" ? "Espèces" : sale.payment_method === "card" ? "Carte" : "N/A"}
                          </Badge>
                    ...
                    <div className="text-right">
                      <p className={`text-lg font-bold bg-gradient-to-r ${gradients[index % gradients.length]} bg-clip-text text-transparent`}>
                        {new Intl.NumberFormat("fr-FR", { notation: "compact" }).format(sale.final_amount || sale.total_amount || 0)}
                      </p>
                      <p className="text-xs font-medium text-muted-foreground">{sale.currency || "FCFA"}</p>
